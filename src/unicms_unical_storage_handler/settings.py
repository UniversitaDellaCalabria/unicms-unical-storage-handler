...
CMS_STORAGE_BASE_URL_VIEW_REGEXP = (
    f"^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_BASE_PATH})(/)?$"  # noqa
)
...
TEACHER_INFO_NOT_SHOW = [
    "TeacherID",
    "TeacherDepartmentID",
    "TeacherLastName",
    "TeacherFirstName",
    "TeacherRole",
    "TeacherRoleDescription",
    "TeacherCVFull",
    "TeacherCVShort",
    "TeacherSSDCod",
...
LABORATORY_INFO_NOT_SHOW = [
    ...
    "LaboratoryTechPersonnel",
    "LaboratoryOfferedServices",
    "LaboratoryServicesScope",
    "LaboratoryTeachingScope",
    "LaboratoryResearchScope",
...
SPINOFF_INFO_NOT_SHOW = [
    ...
    "IsStartup",
    "SpinoffAgencyName",
    "SpinoffUnicalReferentId",
    "SpinoffDescription",
    "TechAreaId",
    "IsActive",
]

HIGH_FORMATION_MASTERS_INFO_NOT_SHOW = [
    "ID",
    "HighFormationTypeId",
...
# ALMALAUREA Link
ALMALAUREA_LINK = (
    "http://statistiche.almalaurea.it/universita/statistiche/trasparenza?codicione="
)
...
HIGH_FORMATION_MASTERS_LINK = (
    "https://unical.portaleamministrazionetrasparente.it/pagina874_tc-9_master.html"
)
...
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesCorsoHandler"
] = CMS_STORAGE_CDS_WEBSITES_CORSO_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesCorsoActivityHandler"
] = CMS_STORAGE_CDS_WEBSITES_CORSO_ACTIVITY_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesIscriversiHandler"
] = CMS_STORAGE_CDS_WEBSITES_ISCRIVERSI_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesOpportunitaHandler"
] = CMS_STORAGE_CDS_WEBSITES_OPPORTUNITA_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesOrganizzazioneHandler"
] = CMS_STORAGE_CDS_WEBSITES_ORGANIZZAZIONE_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesProspectHandler"
] = CMS_STORAGE_CDS_WEBSITES_PROSPECT_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesIsodidHandler"
] = CMS_STORAGE_CDS_WEBSITES_ISODID_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesRedirectHandler"
] = CMS_STORAGE_CDS_WEBSITES_REDIRECT_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesStudyActivityRedirectHandler"
] = CMS_STORAGE_CDS_WEBSITES_REDIRECT_ACTIVITY_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesRedirectProspectHandler"
] = CMS_STORAGE_CDS_WEBSITES_REDIRECT_PROSPECT_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesStudiareHandler"
] = CMS_STORAGE_CDS_WEBSITES_STUDIARE_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesStudiareActivityHandler"
] = CMS_STORAGE_CDS_WEBSITES_STUDIARE_ACTIVITY_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesStudiareCalendarHandler"
] = CMS_STORAGE_CDS_WEBSITES_STUDIARE_CALENDAR_URL_VIEW_REGEXP
CMS_STORAGE_APP_REGEXP_URLPATHS[
    "unicms_unical_storage_handler.handlers.CdsWebsitesStudiareScheduleHandler"
] = CMS_STORAGE_CDS_WEBSITES_STUDIARE_SCHEDULE_URL_VIEW_REGEXP
