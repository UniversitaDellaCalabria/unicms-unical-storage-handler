...
CMS_STORAGE_CDS_WEBSITES_QUALITA_VIEW_PREFIX_PATH = 'qualita'
...
CMS_STORAGE_CDS_WEBSITES_QUALITA_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_CDS_WEBSITES_BASE_PATH})/({CMS_STORAGE_CDS_WEBSITES_QUALITA_VIEW_PREFIX_PATH})(/)?$' # noqa
...
CMS_STORAGE_HANDLERS_PATHS += [
                                ...
                                CMS_STORAGE_CDS_WEBSITES_QUALITA_URL_VIEW_REGEXP,
...
CMS_STORAGE_APP_REGEXP_URLPATHS['unicms_unical_storage_handler.handlers.CdsWebsitesQualitaHandler'] = CMS_STORAGE_CDS_WEBSITES_QUALITA_URL_VIEW_REGEXP
...
CMS_STORAGE_CDS_WEBSITES_QUALITA_LABEL = _("Quality")
