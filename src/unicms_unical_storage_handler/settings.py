...
CMS_WEBPATH_PROSPECT = None # webpath id to nest prospect pages
...
CMS_STORAGE_CDS_WEBSITES_PROSPECT_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_CDS_WEBSITES_BASE_PATH})/(?P<cds_cod>[0-9]*)/({CMS_STORAGE_CDS_WEBSITES_PROSPECT_VIEW_PREFIX_PATH})(/)?$' # noqa
