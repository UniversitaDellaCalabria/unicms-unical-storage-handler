...
CMS_STORAGE_CDS_WEBSITES_CORSO_ACTIVITY_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_CDS_WEBSITES_BASE_PATH})/({CMS_STORAGE_CDS_WEBSITES_CORSO_VIEW_PREFIX_PATH})/(?P<cdsid>[a-z0-9\-]*)/{CMS_STORAGE_ACTIVITY_VIEW_PREFIX_PATH}/(?P<code>[a-z0-9\-]*)(/)?$' # noqa
...
CMS_STORAGE_CDS_WEBSITES_STUDIARE_ACTIVITY_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_CDS_WEBSITES_BASE_PATH})/({CMS_STORAGE_CDS_WEBSITES_STUDIARE_VIEW_PREFIX_PATH})/(?P<cdsid>[a-z0-9\-]*)/{CMS_STORAGE_ACTIVITY_VIEW_PREFIX_PATH}/(?P<code>[a-z0-9\-]*)(/)?$' # noqa
...
CMS_STORAGE_CDS_WEBSITES_CORSO_LABEL = _("Course")
