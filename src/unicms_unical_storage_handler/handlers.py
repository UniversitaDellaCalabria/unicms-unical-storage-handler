...
CMS_STORAGE_CDS_WEBSITES_QUALITA_LABEL = getattr(settings, 'CMS_STORAGE_CDS_WEBSITES_QUALITA_LABEL', CMS_STORAGE_CDS_WEBSITES_QUALITA_LABEL)
...
class CdsWebsitesQualitaHandler(CdsWebsiteBaseHandler):
    template = "storage_cds_websites_qualita.html"

    @property
    def breadcrumbs(self):
        return [('#', CMS_STORAGE_CDS_WEBSITES_QUALITA_LABEL)]
