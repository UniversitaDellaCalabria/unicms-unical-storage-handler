...
class AddressbookInfoViewHandler(BaseStorageHandler):
    ...
    def as_view(self):
        ...
        self.data['page_meta_description'] = f"{person_data['results']['OfficeReference'][0]} - {person_data['results']['Email'][0]} - {person_data['results']['TelOffice'][0]}"
...
class CdsWebsitesIsodidHandler(CdsWebsiteBaseHandler):
    template = "storage_cds_websites_isodid.html"
